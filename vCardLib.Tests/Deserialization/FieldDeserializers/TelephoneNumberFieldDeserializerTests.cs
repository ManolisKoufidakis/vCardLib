...
public class TelephoneNumberFieldDeserializerTests
{
    ...
    [Test]
    public void V4ShouldParseWhenTypeKeywordIsOmittedForMetadataAndHasMultipleValues()
    {
        const string input = "TEL;WORK;CELL:+1-213-555-1234";
        IV4FieldDeserializer<TelephoneNumber> deserializer = new TelephoneNumberFieldDeserializer();
        var result = deserializer.Read(input);
    ...
    [Test]
    public void V4ShouldParseWhenTypeKeywordIsOmittedForMetadataAndHasPref()
    {
        const string input = "TEL;WORK;PREF=1:+1-213-555-1234";
        IV4FieldDeserializer<TelephoneNumber> deserializer = new TelephoneNumberFieldDeserializer();
        var result = deserializer.Read(input);
